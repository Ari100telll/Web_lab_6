...
import { StyledHome, InfoTitle, StyledEvents, StyledCardComponents, StyledCard } from "./home.style";
...
const Home = () => {
    ...
    return (
        <StyledHome>
            ...
            <StyledEvents>
                {
                    data.map(({ imgSrc, title, duration, price }, idx) => (
                        <StyledCard
                            hoverable
            ...
            <Button size="large" style={{ borderRadius: 5 }}>Veiw more</Button>
